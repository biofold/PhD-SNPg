...
def get_ucsc_data(hg,namefile,odir,ucsc_dat='http://hgdownload.cse.ucsc.edu/goldenPath'):
	...
	prog_get = 'wget'
	print >> sys.stderr,'   Download',namefile
...
def setup(arch_type,hg='all'):
	...
	print >> sys.stderr,'   Downloaded UCSC data'
...
def test():
	...
	if out[0]!=0:
		...
		sys.exit(1)
	print >> sys.stderr,'6) Test bigWigToBedGraph command'
	if hgs[-1]=='hg19':
